...
def draw_bounding_box_on_image(current_frame_number,image,
  ...
  im_height=im_height-interest_area_ypos_start-(im_height-interest_area_ypos_end)
...
def draw_single_bounding_box_on_image_array(image,
                                     ymin,
                                     xmin,
                                     ymax,
                                     xmax,
  ...
  draw_single_bounding_box_on_image(image_pil, ymin, xmin, ymax, xmax, color,
                             thickness, display_str_list,
                             use_normalized_coordinates,
                             ...
                             interest_area_ypos_end=interest_area_ypos_end)
  np.copyto(image, np.array(image_pil))
def draw_single_bounding_box_on_image(image,
                               ymin,
                               xmin,
                               ymax,
                               xmax,
...
#                 is_vehicle_detected = []
                 is_vehicle_detected=False
            if(predicted_speed >SPEED_LIMIT):
                current_ovrerspeed_image = origin_image.copy()
                draw_single_bounding_box_on_image_array(current_ovrerspeed_image,
                 ymin,
                 xmin,
                 ymax,
                 xmax,
